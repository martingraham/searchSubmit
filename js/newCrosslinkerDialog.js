...
(function (obj) {
    ...
    *   @param crosslinkerPopulateOptionList - data about the multiple select widget and data this dialog originated from
    *   @param updateFunction - function in submit.js that rebuilds a multiple select widget - called after new crosslinker added
    */
    obj.addCrosslinkerDialog = function (dialogID, data, crosslinkerPopulateOptionList, updateFunction) {
            ...
            $.ajax ({
                ...
                success: function (response, textStatus, jqXhr) {
                    if (response.error) {
                        ...
                        crosslinkerPopulateOptionList.data.push (newCrosslinker);	// crosslinkerPopulateOptionList.data IS data.xlinkers
                        crosslinkerPopulateOptionList.isOpen = false;
                        // update the associated multiple select widget
                        updateFunction (crosslinkerPopulateOptionList, newCrosslinker);
                    }
                },
                error: function () {
        ...
        var addCrosslinkerBaseOptions = function (container) {
            ...
            $("#newCrosslinkerSelect").multipleSelect({
                ...
                onUncheckAll: function () {
                    //selectionChanged (this, crosslinkerPopulateOptionList.clickFunc);
                },
            });
        }
